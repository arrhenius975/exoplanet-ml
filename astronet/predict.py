...
def _process_tce(args, feature_config):
  ...
  if args.output_image_file:
    ...
    fig.tight_layout()
    fig.savefig(args.output_image_file, bbox_inches="tight")
...
args):
  ...
  features = _process_tce(args, nput features.
